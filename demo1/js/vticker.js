...
(function(d) {
    var g, c, f;
    g = { ul: '', li: '', speed: 700, pause: 4E3, showItems: 1, mousePause: !0, height: 0, animate: !0, margin: 0, padding: 0, startPaused: !1, autoAppend: !0 };
    c = {
        ...
        nextItemState: function(a, b) {
            var e, c;
            c = a.element.children(g.ul);
            e = a.itemHeight;
            0 < a.options.height && (e = c.children(g.li + ":first").height());
        ...
        setItemLayout: function(a, b, c) {
            var f;
            a.css({ overflow: "hidden", position: "relative" }).children(g.ul).css({ position: "absolute", margin: 0, padding: 0 }).children(g.li).css({
                margin: c.margin,
                padding: c.padding
            });
            return isNaN(c.height) || 0 === c.height ? (a.children(g.ul).children(g.li).each(function() { if (d(this).height() > b.itemHeight) return b.itemHeight = d(this).height() }), a.children(g.ul).children(g.li).each(function() { return d(this).height(b.itemHeight) }), f = c.margin + 2 * c.padding, a.height((b.itemHeight + f) * c.showItems + c.margin)) : a.height(c.height)
        },
        defaultStateAttribs: function(a, b) {
            return {
                itemCount: a.children(g.ul).children(g.li).length,
                itemHeight: 0,
                itemMargin: 0,
                element: a,
                animating: !1,
